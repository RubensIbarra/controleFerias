...
<html>
    <head>
            ...
            <link rel="shortcut icon" href="ibm.ico" type="image/x-icon" />
                <meta charset="utf-8">
    ...
    <?php endif: ?>
     <div id=topo>
            ...
            <img src = "IBM.png" width = "250px" height = "125px">
            <h2>Requerimento de Férias</h2>
        ...
        <input type="text" name="ID_IBM" placeholder="Enter your ID:" required></input>

        <div id="data">
        <h4>Data de Início:</h4>
        <!--inicio input calendar new-->
        <input type="text" id="datepicker" name="DATA_INICIO"/>
            <!--fim input calendar new-->

            <!--inicio var calendar new-->
     ...
     <h4>Data de Término:</h4>
      <!--inicio input calendar new-->
      <input type="text" id="datepicker2" name="DATA_TERMINO"/>
      <!--fim input calendar new-->
     ...
     <!--fim var calendar new-->
     </div>

     <h4>Observações:</h4>

     <textarea id="txt1" name="OBS" cols="40" rows="5"></textarea>

     <input id="button" type="submit" action="send()">
...
?>
     ...
     <!--style pikaday.css new calendar -->
